...
import "./app.scss";
import { mystore, Assetgroups } from "./assetTypesMappingData.js";
...
class AssetTypesx extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="content-block dx-card responsive-paddings">
        ...
        >
          ...
          <Column dataField="ASSETTYPEGROUPCODE" caption="Group">
            <Lookup
              dataSource={this.state.assetGroupsCodes}
              valueExpr="ASSETTYPEGROUP"
...
export default function AssetTypes() {
  const { user } = useAuth();
  //console.log({ user });
  return <AssetTypesx companyCode={user.companyCode} />;
}
